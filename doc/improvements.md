...
This document outlines potential performance and architectural improvements for the arcivis-layout engine.
...
impl LayoutQuality {
    ...
    pub fn to_config(&self) -> ArciVisLayout {
        match self {
            LayoutQuality::Draft { iterations } => ArciVisLayout {
...
pub struct ProgressiveLayout {
    coarse_layout: ArciVisLayout,
    medium_layout: ArciVisLayout,
    fine_layout: ArciVisLayout,
}
